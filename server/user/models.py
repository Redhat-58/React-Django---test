...
class User(AbstractBaseUser):
    ...
    wallet_address = models.CharField(max_length=42, blank=False, null=False, default='0x0000000000000000000000000000000000000000')
    eth_balance = models.DecimalField(max_digits=30, decimal_places=18, default=0)
    ...
    REQUIRED_FIELDS = ['first_name', 'last_name', 'wallet_address', 'eth_balance']
